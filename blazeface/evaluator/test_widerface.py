...
import numpy as np
from config.config import cfg_mnet, cfg_slim, cfg_rfb, cfg_blaze
...
parser.add_argument('-m', '--trained_model', default='./weights/Blaze_burn_in.pth',
...
parser.add_argument('--output_folder', default='./result_2/', help='save visual image in folder')
...
if __name__ == '__main__':
    ...
    for i, img_name in enumerate(test_dataset):
        ...
        if args.save_image:
            ...
            name = args.output_folder + str(i) + ".jpg"
